      ...
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center gap-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-text-muted">Dataset {loaded ? `(${total} frases)` : "no cargado"} · Hoy: {kpis.todayMin} min · Acierto: {kpis.acc}% · 🔥 {kpis.streak}d</p>
          </div>
        </div>
        ...
        <span className="hidden md:inline-flex items-center text-xs text-text-muted mr-2" title="Tarjetas vencidas hoy">🔁 Estudio hoy: <b className="ml-1">{dueCount}</b></span>
